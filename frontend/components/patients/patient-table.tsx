...
export function PatientTable({ data, onEdit, onDelete, onView, isLoading }: PatientTableProps) {
          ...
          <TableBody>
            {isLoading ? (
              Array.from({ length: 5 }).map((_, idx) => (
                <TableRow key={`skeleton-${idx}`} className="hover:bg-gray-50/50 transition-colors">
                  <TableCell>
